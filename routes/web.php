...
Route::group(['prefix' => 'admin'], function () {
    ...
    Route::group(['middleware' => 'isadmin'], function () {
        ...
        Route::post('dashboard/confirmsub/{id}', 'Admin\LogicController@confirmsub');
...
Route::get('dashboard/deletewdmethod/{id}', ['middleware' => ['auth', 'admin'], 'uses' => 'Admin\SettingsController@deletewdmethod']);
...
Route::get('admin/dashboard/deletewdmethod/{id}', 'Admin\SettingsController@deletewdmethod');
