  ...
  return $referedMembers;
   ...
   //fetch Coinpayment merchant credentials
    ...
    public function getMatchingBonus($sponsor,$amount){
        ...
        $dwlns = users::where('ref_by',$sponsor)->where('bonus_matched','<>','matched')->get();
        
        //get sponsor
        $spnsr=users::where('id',$sponsor)->first();
    ...
    public function creditLeadershipBonus($sponsor,$amnt){
        $array = users::orderby('id','asc')->where('ref_by',$sponsor)->take(10);
